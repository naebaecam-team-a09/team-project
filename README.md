...
- [ ] 이메일 & 패스워드 / 소셜 로그인 기능(카카오,  애플)
- [ ] 회원가입 기능(이메일, 패스워드, 닉네임, 성별)
- [ ] 날씨에 따른 코디 추천 기능 / 사용자가 작성한 게시글의 좋아요 수 기반으로 인기 게시글 정렬 기능
- [ ] 게시글 작성, 수정, 삭제 기능(사진,  제목,  본문, 카테고리)
- [ ] 사용자가 작성한 게시글 확인 / 사용자 정보 확인 및 수정 가능 (프로필 사진 , 닉네임)
- [ ] 댓글 작성 및 수정, 삭제 / 좋아요 기능
